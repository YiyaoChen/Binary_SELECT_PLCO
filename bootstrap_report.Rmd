...
paste0('AUC: ', round(t1$auc[1], 3)*100,'%')
```
...
```{r, include=FALSE}
boot50_1 <- read.csv('/Users/yiyaochen/Binary_SELECT_PLCO/boot50_Oct30.csv')
boot50_2 <- read.csv('/Users/yiyaochen/Binary_SELECT_PLCO/boot50_2_Oct30.csv')

boot_result <- rbind(boot50_1, boot50_2)
```
